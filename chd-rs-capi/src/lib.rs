...
extern "C" fn chd_open_file(
    ...
    let bufread = Box::new(BufReader::new(file)) as Box<dyn ReadAndSeek>;
    ...
    unsafe { *out = Box::into_raw(Box::new(chd)) }
